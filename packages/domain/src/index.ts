...
export type Services = {
  ...
  media: MediaService;
  configuration?: () => Promise<AppConfiguration>;
  reference: {
...
export type ShopCategory = { name: string; icon: string; subcategories: string[] };
export type InformationPage = { title: string; sections: [string, string][] };
export type AppConfiguration = {
  shopName: string; tagline: string; logo: string; bannerImage: string; bannerTitle: string;
  bannerButton: string; bannerTarget: "Medicines" | "Doctors" | "Request";
  featuredIds: string[]; categories: ShopCategory[];
  pages: Record<"help" | "terms" | "privacy" | "about", InformationPage>;
  orderSuccess: string; requestSuccess: string; supportPhone: string; supportEmail: string;
  demoMode: boolean;
};
